...
int empleado_modificarMenu(Empleado* array, int len, int reintentos)
{
    int retorno = -1;
    Empleado *empleadoModificado = NULL;
    int elegirOpcion = 0;
    ...
    if(empleadoModificado != NULL)
    {
        ...
        {
            case 1:
                if(!utn_getAlfabetico(nombre, 51,"Nombre empleado?\n","nombre no valido\n",2))
                {
                    strncpy(empleadoModificado->nombre, nombre, 51);
                    retorno = 0;
                }
                break;
            case 2:
                if(!utn_getAlfabetico(apellido, 51,"Apellido empleado?\n","apellido no valido\n",2))
                {
                    strncpy(empleadoModificado->apellido, apellido, 51);
                    retorno = 0;
                }
